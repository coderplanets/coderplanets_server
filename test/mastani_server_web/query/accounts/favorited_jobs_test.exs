defmodule GroupherServer.Test.Query.Accounts.FavritedJobs do
  ...
  setup do
    ...
    {:ok, ~m(guest_conn user_conn user jobs)a}
  end
  ...
  describe "[accounts favorited jobs]" do
    ...
    """
    test "login user can get it's own favoritedJobs", ~m(user_conn user jobs)a do
