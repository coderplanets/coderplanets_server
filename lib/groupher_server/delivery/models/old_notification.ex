defmodule GroupherServer.Delivery.Model.OldNotification do
  @moduledoc false
  alias __MODULE__
  ...
  @type t :: %OldNotification{}
  schema "old_notifications" do
  ...
  @doc false
  def changeset(%OldNotification{} = notification, attrs) do
    notification
