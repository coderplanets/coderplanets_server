defmodule GroupherServer.CMS do
  ...
  # Comment CURD
  defdelegate paged_article_comments(thread, article_id, filters, mode), to: CommentCurd
  defdelegate paged_article_comments(thread, article_id, filters, mode, user), to: CommentCurd
  ...
  defdelegate paged_article_comments_participants(thread, content_id, filters), to: CommentCurd

  defdelegate create_article_comment(thread, article_id, args, user), to: CommentCurd
  defdelegate update_article_comment(comment, content), to: CommentCurd
  defdelegate delete_article_comment(comment), to: CommentCurd
  ...
  defdelegate pin_article_comment(comment_id), to: CommentAction
  defdelegate undo_pin_article_comment(comment_id), to: CommentAction
